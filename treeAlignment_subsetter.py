...
class parseArgs():
	def __init__(self):
		#Define options
		try:
			options, remainder = getopt.getopt(sys.argv[1:], 'hs:f:r:t:p:o:m:', \
			["help", "reps=","tree=","phylip=","out=", "method=", "samples=", "freq="])
	...
	def display_help(self, message=None):
		...
		print ("Description: Generate random subsets of an input phylogenetic dataset (tree and alignment)")
		print("""
		-t,--tree	: Path to input newick file
